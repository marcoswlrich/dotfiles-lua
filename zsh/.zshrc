...
# use fzf para abrir um diretório em algum lugar aninhado após $HOME
c() {
  cd "$(fd -t d --color=never . "$HOME" | fzf --preview='tree -L 1 -I {}')"
  cmd_exists lsd && lsd -A || ls -A
}

# abre um arquivo no neovim com fzf do diretório atual
f() {
...
SPACESHIP_PROMPT_ORDER=(
  ...
  hg
  exec_time
  node           # Mercurial section (hg_branch  + hg_status)
